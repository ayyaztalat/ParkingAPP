...
public class MyBookingClass extends Fragment {
    ...
    public static MyBookingClass newInstance(String param1, String param2) {
        MyBookingClass fragment = new MyBookingClass();
